...
class TestLoadAndValidateEnv:
    ...
    def test_raises_value_error_when_vars_missing(self, tmp_path):
        ...
        """
        env_file = tmp_path / ".env"
        # Le fichier ne contient qu'une variable, il en manque trois
    ...
    def test_returns_env_dict_when_valid(self, tmp_path):
        ...
        env_file.write_text(
            ...
            "url_situation_copro=http://situation.example.com\n"
        )
        ...
        try:
            ...
            with patch(
                ...
                assert result["url_situation_copro"] == "http://situation.example.com"
